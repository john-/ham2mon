...
def main():
    ...
    print(f'should be data (V): {classifier.is_wanted("test/voice.wav")}')
    print(f'should be data (D): {classifier.is_wanted("test/data.wav")}')
    print(f'should be skip (S): {classifier.is_wanted("test/skip.wav")}')
