...
1.  If not recording, a _channel opening_ will be considered activity.
2.  If recording, the _completion of a recording_ will be considered activity.
...
AGC may be _enabled_ in one of two ways (SDR dependent):
...
AGC may be _configured_ via hardware argument supplied to ham2mon (`-a` option):
...
_Note: The classification is not 100% accurate. There will be both false positives and negatives._
